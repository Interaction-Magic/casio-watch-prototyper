...
document.addEventListener("DOMContentLoaded", () => {
	...
	copy_watch_display(document.querySelector(".watch_outline"));



	document.querySelectorAll(".segments").forEach((svg) => {
		svg.innerHTML = segments_source;
	});
	...
	new Animation({
		...
		prototype_container: document.querySelector(".animation_prototype")
	});
